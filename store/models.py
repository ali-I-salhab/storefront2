...
# # first aproach extend user model user for adding any field related to authentication
# class Appuser(User,models.Model):
#     ff=models.CharField(max_length=255)
#     # second aproach for adding any filed without auth info 
...
class Customer(models.Model):
    ...
    # this fields exist in the user model
    # first_name = models.CharField(max_length=255)
    # last_name = models.CharField(max_length=255)
    # email = models.EmailField(unique=True)
    phone = models.CharField(max_length=255)
    # when delete user customer will deleted customer is child user is parent
...
class CartItem(models.Model):
    ...
    quantity = models.PositiveSmallIntegerField(validators=[MinValueValidator(3)])
    class Meta:
